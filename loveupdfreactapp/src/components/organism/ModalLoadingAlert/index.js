...
class ModalLoadingAlert extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    // }
    if (
      nextProps.hasOwnProperty("isOpen") &&
      ...
      if (nextProps.isLoading) this.handleLoadingProgress();
        ...
        if (nextProps.msg.err != null)
          this.handleResponseProgress("error", nextProps.msg.err);
        else if (nextProps.msg.success != null)
          this.handleResponseProgress("success", nextProps.msg.success);
      }
    }
  }
