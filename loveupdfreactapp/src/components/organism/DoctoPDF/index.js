...
class DoctoPDF extends Component {
	...
	doctoPDF = () => {
		...
		.then(function (response) {
			...
			downloadLink.download = "loveupdf_word_to_pdf_" + new Date().toISOString().replace(":","_").replace("T","_").replace("Z","") + ".pdf";
			downloadLink.click();
			...
			this1.setState({
                ...
                modalLoading: false,
                modalMsg: {
                    success: 'Doc To Pdf Convertion Completed successfully and downloaded!\n',
                    err: null,
                }
            })
		})
		.catch(function (response) {
			...
			this1.setState({
                ...
                modalMsg: {
                    success: null,
                    err: response ? response : 'Oopps ! something went wrong\n',
                }
